...
void onTick(CBlob@ this)
{
	...
	if(isServer())
	{
		if(this.get_s32("currentKnightState") != 0 && this.get_s32("currentKnightState") != 1)
		{
			printf("state: " + this.get_s32("currentKnightState") + " getgametime " + getGameTime());
		}
	}
...
{
	//return if we collided with map, door/platform, or something non-fleshy (like a boulder)
